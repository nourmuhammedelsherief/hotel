...
@section('title')
    @lang('messages.edit') @lang('messages.clients')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.clients') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.clients') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('clients.update' , $user->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="phone_number" type="number" class="form-control" value="{{$user->phone_number}}" placeholder="@lang('messages.phone_number')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="active" type="radio" {{$user->active == 'true' ? 'checked' : ''}} value="true"> @lang('messages.yes')
                                    <input name="active" type="radio" {{$user->active == 'false' ? 'checked' : ''}} value="false"> @lang('messages.no')
